namespace Recommendations
{
    ...
    public class RecommendationsApiWrapper
    {
        ...
        /// </returns>
        public RecommendedItemSetInfoList GetRecommendationsList(string modelId, long buildId, string itemIds, int numberOfResults)
        {
            var jsonString = GetRecommendations(modelId, buildId, itemIds, numberOfResults);
        ...
        public string GetRecommendations(string modelId, long buildId, string itemIds, int numberOfResults)
        {
        ...
        public RecommendedItemSetInfoList GetUserRecommendationsList(string modelId, long buildId, string userId, int numberOfResults)
        {
            var jsonString = GetUserRecommendations(modelId, buildId, userId, numberOfResults);

            var recommendedItemSetInfoList = JsonConvert.DeserializeObject<RecommendedItemSetInfoList>(jsonString);
            return recommendedItemSetInfoList;
        }

        public string GetUserRecommendations(string modelId, long buildId, string userId, int numberOfResults)
        {
