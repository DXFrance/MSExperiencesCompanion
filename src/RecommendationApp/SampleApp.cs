...
namespace Recommendations
{
    ...
    {
        private static string AccountKey = "87c68aa99a23478fbf137408798b9897";
        ...
        public static long UploadDataAndTrainModel(string modelId, BuildType buildType = BuildType.Recommendation)
        {
            ...
            Console.WriteLine($"Imported {catalogFilesCount} catalog files.");
            ...
            Console.WriteLine($"Imported {usageFilesCount} catalog files.");
        ...
        public static void GetRecommendationsSingleRequest(RecommendationsApiWrapper recommender, string modelId, long buildId)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Getting Item to Item EXP036");
            const string itemIds = "EXP036";
            ...
            Console.WriteLine();
            Console.WriteLine("Getting User Recommendations for User: 2918");
            string userId = "2918";
